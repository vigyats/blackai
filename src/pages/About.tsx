...
const team = [
  ...
  { name: 'Tanaya Pillewan', role: 'CRO, BDM & Co-founder', image: '/tanaya.png', linkedin: 'https://www.linkedin.com/in/tanaya-pillewan-38370a256/' },
  { name: 'Suraj Dudhe', role: 'CTO & Co-founder', image: '/suraj.png', linkedin: 'https://www.linkedin.com/in/suraj-dudhe-70b16b209/' },
];
              ...
              <AnimatedSection key={member.name} delay={index * 0.1}>
                ...
                >
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-foreground bg-accent/10 hover:bg-accent/20 border border-accent/30 hover:border-accent/50 rounded-md transition-all"
                  >
