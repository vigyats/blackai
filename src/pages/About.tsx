                ...
                >
                  ...
                  {member.linkedin && (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-background bg-gradient-to-r from-accent to-yellow-500 hover:from-yellow-500 hover:to-accent rounded-full transition-all shadow-lg shadow-accent/20 hover:shadow-accent/40"
                    >
